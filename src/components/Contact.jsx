...
function Contact() {
  return (
    <section
      id="contact"
      className="min-h-screen scroll-mt-20 bg-pink-950 py-12 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-lg text-gray-200 max-w-2xl mx-auto">
          ...
          nemo assumenda reiciendis, similique ipsa veniam dicta ratione aliquid
        </p>
      </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-100">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800">+088 01718011234</p>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-pink-200 hover:bg-gray-200 p-3 rounded-full transition duration-300"
                >
