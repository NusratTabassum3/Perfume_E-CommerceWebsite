            ...
            {visibleProducts.map((product) => (
              ...
              >
                <div className="relative">
                  ...
                  {product.discount > 0 && (
                    <span className="absolute top-3 right-3 bg-red-500 text-white text-xs font-bold px-2 py-2 rounded">
                      -{product.discount}%
                    </span>
                  )}
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="p-2 bg-pink-950 rounded text-white hover:bg-pink-700 transition-colors">
