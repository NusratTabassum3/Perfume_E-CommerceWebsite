...
function About() {
  return (
    <section
      id="about"
      className="min-h-screen scroll-mt-20 bg-gradient-to-b from-gray-50 to-white
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-20">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Perferendis laudantium nesciunt corporis nisi at dignissimos,
              adipisci facilis, quod explicabo itaque dolorem doloribus laborum
              voluptatem sequi, dicta laboriosam nostrum tempore tenetur.
            </p>
