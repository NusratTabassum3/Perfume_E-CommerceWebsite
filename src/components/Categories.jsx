  ...
  const categories = [
    {
      ...
      descripiton: "amet consetetur adipiscing elit.",
    },
    {
      img: product9,
      alt: "Women's Perdfumes",
      title: "Women's Collection",
      descripiton: "amet consetetur adipiscing elit.",
    },
    {
      img: product10,
      alt: "Luxury Perdfumes",
      title: "Luxury Edition",
      descripiton: "amet consetetur adipiscing elit.",
    },
    {
      img: product11,
      alt: "Unisex Perdfumes",
      title: "Unisex Edition",
      descripiton: "amet consetetur adipiscing elit.",
    },
    {
      img: product12,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-800 max-w-2xl mx-auto">
            ...
            aperiam tempora eum nisi natus, placeat perferendis.
          </p>
        </div>
